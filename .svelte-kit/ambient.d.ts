...
declare module '$env/static/private' {
	...
	export const FLAG_GIT_IN_THE_SHELL: string;
	...
	export const REPL_RENEWAL_KEY: string;
	...
	export const REPL_RENEWAL: string;
	export const outputs: string;
	export const NIX_STORE: string;
	export const GIT_ASKPASS: string;
	export const REPL_IMAGE: string;
	export const LD: string;
	export const FLAG_SECCOMP_PORT_DETECTION: string;
	...
	export const FLAG_MULTIPLE_PORTS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		REPL_IMAGE: string;
		LD: string;
		FLAG_SECCOMP_PORT_DETECTION: string;
		INIT_CWD: string;
		READELF: string;
